...
const Button = ({ children, leadingIcon, iconOnly, isStickyButton }: Props): JSX.Element => {
  ...
  return (
    <div className='rounded-[14px] bg-gradient-to-b from-[#EFEFEF] to-[#FFFFFF] p-1 shadow-[inset_0_1px_1px_rgb(0_0_0_/_0.02),_0_8px_16px_rgb(0_0_0_/_0.02)] select-none'>
      <button
        ...
        onMouseUp={() => up()}
        className={cn(
          'group relative h-[38px] items-center justify-center rounded-[10px] bg-gradient-to-b from-[#FFFFFF] to-[#ECECEC] px-3.5 text-sm font-semibold transition',
